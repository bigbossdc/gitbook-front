   ...
   render() {
      return (
         <Fragment>
            ...
            />
            <li className="dropdown notification-list" style={{ display: "block", padding: "0px auto", width: "62px" }}>
               {/** 알림 버튼 아이콘*/}
               <a className="nav-link dropdown-toggle" data-toggle="dropdown" aria-expanded="true">
                  <i className="fa fa-bell noti-icon" style={{ display: "inline-block", cursor: "pointer", paddingLeft: this.state.alarmList === null || this.state.alarmList.length === 0 ? "15px" : "0px" }}></i>
