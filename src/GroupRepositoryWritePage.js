...
class MyRepositoryWritePage extends Component {
   ...
   handleSubmit = () => {
      ...
      setTimeout(() => {
      window.location="/gitbook/group/" + this.props.groupno + "/" + sessionStorage.getItem("authUserNo") + "/" + sessionStorage.getItem("authUserId") + "/repository/view/" + this.state.gitName
      },500);
   };
