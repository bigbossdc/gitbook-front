            ...
            <div className="cardbox">
               ...
               <div className="media m-0">
                <div className="media-body">
                    <span style={k}></span>
                    <Link to="/gitbook/group/repository/detail" className="text-muted" style={{fontFamily: " 'Varela Round', sans-serif",fontSize:"1.9em",display:"inline-block",marginBottom:"10px"}}>
                      Mysite06</Link>
