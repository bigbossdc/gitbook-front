					...
					<li
						...
						<div className="user-message-details">
							...
							<div class="user-message-info" style={{ width: "250px" }}>
								...
								<p className="txt_post" style={{ fontFamily: "'Jeju Gothic', sans-serif" }}>{this.props.list.lastMsg && this.props.list.lastMsg.type=='image'?'사진': this.props.list.lastMsg.contents}</p>
