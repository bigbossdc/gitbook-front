...
class ChatFriendJoinItem extends Component {
    ...
    render() {
        return (
            <div>
                <li>
                    {this.props.inviteList && this.props.inviteList.some((list) => list === this.props.list) ?
                        <div className="media" id='media' onClick={
                        ...
                        <div className="media" id='media' onClick={this.addList.bind(this)} >
