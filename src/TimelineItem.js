             ...
             <div className="media m-0">
               < div className="d-flex mr-3">
                ...
                <div className="media-body">
                    <p className="m-0" style={{fontFamily: " 'Varela Round', sans-serif"}}>지존혜딘공듀</p>
...
<li><a href="#" title="" className="com"><i className="fa fa-comments"></i></a> <span class="span-last">50 </span></li>
</ul>
 </div>
